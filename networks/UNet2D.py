...
class UpBlock(nn.Module): 
    """
    Upsampling followed by the ConvBlock
    """
    def __init__(self, in_channels1, in_channels2, out_channels, dropout_p): 
        super(UpBlock, self).__init__()
        self.convx1 = nn.Conv2d(in_channels1, in_channels2, kernel_size= 1) 
...
class Decoder(nn.Module): 
    def __init__(self, params): 
        ...
        self.conv = nn.Conv2d(self.ft_chns[0], self.n_class, kernel_size=3, padding=1) 
